...
#
#     from array_splitter import metadata
#
# However, when we do this, we also import `array_splitter/__init__.py'.If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'array_splitter_cli = array_splitter.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'array_splitter_gui = array_splitter.gui:entry_point'
        # ]
    }
)
